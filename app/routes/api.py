...
def signup():
    ...
    try:
        ...
        #insert to database failed so send error to front end and rollback the database
...
def comment():
    ...
    try:
        ...
        #display error occured with creating the comment 
        print(sys.exc_info()[0])
...
def upvote():
    ...
    try:
        ...
        db.add(newVote)
        db.commit()
        print('submitted vote')
    except:
        #display error if upvote fails
        print(sys.exc_info()[0])
